...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $post_data['f_username'] =$request->f_username;
        $post_data['c_username'] =$request->c_username;
        $post_data['crop_id'] = $request->crop_id;
        $post_data['cus_name'] = $request->customer_name;
        $post_data['cus_email'] = $request->customer_email;
        $post_data['cus_add1'] = $request->address;
        $post_data['division'] = $request->division;
        ...
        $update_product = DB::table('orders')
            ...
            ->updateOrInsert([
                'f_username' => $post_data['f_username'],
                'c_username' => $post_data['c_username'],
