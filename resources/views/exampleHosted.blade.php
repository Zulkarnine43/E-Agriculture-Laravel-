...
<div class="container">
    ...
    <div class="row">
            ...
            <h4 class="d-flex justify-content-between align-items-center mb-3">
             ...
             <ul class="list-group mb-3">
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                    <div>
                        <h6 class="my-0">Crop name</h6>
                
                    </div>
                    <span class="text-muted">{{$crop->crop_name}}</span>
                </li>
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                    <div>
                        <h6 class="my-0">Crop Quantity</h6>
                       
                    </div>
                    <span class="text-muted">{{$crop->crop_quantity}}</span>
                </li>
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                    <div>
                        <h6 class="my-0">Crop Location</h6>
                       
                    </div>
                    <span class="text-muted">{{$crop->crop_location}}</span>
                </li>
        ...
        <div class="col-md-8 order-md-1">
            ...
            <input type="hidden" id="f_username" name="f_username" value="{{$crop->username}}">
             <input type="hidden" id="c_username" name="c_username" value="{{Session()->get('c_username')}}">
             <input type="hidden" id="crop_id" name="crop_id" value="{{$crop->id}}">
            <div class="row">
    ...
    <footer class="my-5 pt-5 text-muted text-center text-small">
        <p class="mb-1">&copy; 2020 AGROBID LIMITED</p>
