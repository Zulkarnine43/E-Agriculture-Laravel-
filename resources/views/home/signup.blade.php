        ...
        <form class="form-group" action="{{route('registerSave')}}" method="POST">
            ...
            <div>
             ...
             <div class="form-group row">
                 <!-- Registration Type-->
                  <label class="col-sm-2">Registration Type</label>
                    <div class="col-sm-10">
              ...
              <div class="form-group row">
                  <!-- Username-->
                    ...
                    <div class="col-sm-10">
                    <input type="text" class="form-control" id="username" name="username" placeholder="xyz123" required>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="tel" class="form-control" id="mobile" name="mobile" placeholder="8801xxxxxxxxx" required>
            ...
            <div class="form-group row">
             <!-- Zip code-->
                ...
                <div class="col-sm-10">
                    <input type="number" class="form-control" id="zip_code" name="zip_code" placeholder="xxxx"  required>
               ...
               <div class=" form-group row">
                 <!-- Gender-->
                  <label class="col-sm-2 pt-0">Gender</label>
